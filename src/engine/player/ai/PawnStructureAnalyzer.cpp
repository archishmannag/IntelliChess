...
{
    return net_isolated_pawn_penalty(p) + net_doubled_pawn_penalty(p);
}
...
int pawn_structure_analyzer::calculate_pawn_column_stack_penalty(std::array<int, 8> pawns_on_column)
{
